...
const Hero = ({ DATA }) => {
  return (
    <section
      id="about-me"
      className="relative z-10 break-words px-4 sm:px-6 mx-auto pt-20 sm:pt-24 md:pt-32 grid grid-cols-3 md:gap-4 place-items-center justify-items-center"
    >
      <article className="col-span-full md:col-span-2">
        <h3 className="text-xl font-bold">Hello! I'm {DATA?.name.split(' ')[0]}.</h3>
        <h1 className="text-4xl">
          A <i className="">passionate</i> Full Stack Developer
        </h1>
